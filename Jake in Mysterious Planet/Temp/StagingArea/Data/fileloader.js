...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4044821;
      var PACKAGE_UUID = '5bb852d8-991e-48be-9e9c-58fac65233c1';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20740, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20740, 32460, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(32460, 81380, 0, 0).open('GET', '/level0');
    new DataRequest(81380, 81582, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(81582, 84832, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(84832, 647400, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(647400, 2459096, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2459096, 3956468, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3956468, 4017196, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(4017196, 4044821, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
