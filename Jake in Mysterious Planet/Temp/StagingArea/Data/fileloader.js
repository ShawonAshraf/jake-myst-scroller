...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4044959;
      var PACKAGE_UUID = '18876a47-e83a-4714-a138-c9a81a66a89c';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    new DataRequest(32460, 81404, 0, 0).open('GET', '/level0');
    new DataRequest(81404, 81608, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(81608, 84858, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(84858, 647330, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(647330, 2459234, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2459234, 3956606, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3956606, 4017334, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(4017334, 4044959, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
